...
export default function Banner1() {
  ...
  return (
    <div className={`relative w-full mx-auto ${styles.reflexoBrilhante}`}>
      <Image alt="Produtos Sob Medida" src={banner2} className="w-full" />
      <div
        className="
      ...
      >
        ...
        <h1
          className="
            text-white text-shadow text-left
            text-[2.5vw] sm:text-[2.5vw] md:text-[2.3vw] lg:text-[2vw]
            relative
          "
        >
        ...
        <div className="w-full mt-2 sm:mt-6 md:mt-3 lg:mt-5">
          {/* H2-1 */}
          <h2
            className="
              text-white text-shadow text-left 
              text-[4vw] sm:text-[4vw] md:text-[3.5vw] lg:text-[3vw]
              relative
            "
          >
        ...
        <div className="flex flex gap-2 md:flex-row items-center mt-2 lg:mt-5 w-full">
          {/* P */}
          <p
            className="
              text-white text-shadow text-left 
              text-[2.5vw] sm:text-[3vw] md:text-[2.5vw] lg:text-[2vw]
              relative
            "
          >
          ...
          <div className="flex justify-start md:ml-6 gap-4 lg:gap-6">
            <a href="https://www.instagram.com/sobrinha_artesanatos/" target="_blank">
                <AiFillInstagram className="fill-white text-[5.3vw] sm:text-[4.2vw] md:text-[3.2vw] lg:text-[2.7vw] hover:fill-pink-500
                transition-all duration-500" /></a>
            <a href="https://www.facebook.com/sobrinha_artesanatos" target="_blank"><FaFacebook className="fill-white text-[5vw] sm:text-[4vw] md:text-[3vw] lg:text-[2.5vw] hover:fill-pink-500
                transition-all duration-500" /></a>
            <a href="https://wa.me/5511980187457?text=Olá!%20Gostaria%20de%20fazer%20uma%20encomenda!" target="_blank"><IoLogoWhatsapp className="fill-white text-[5vw] sm:text-[4vw] md:text-[3vw] lg:text-[2.5vw] hover:fill-pink-500
                transition-all duration-500" /></a>
          </div>
        </div>
      </div>
